...
class LoginScreenPassword:
    def __init__(self, args):
        ...
        self.sign_up_nav = tk.Button(text="Sign Up", font=font_tuple, command=lambda: screen_switcher.switch_screens(self.screen, "login_pass", "signup", screen_switcher))
        self.sign_up_nav_window = login_illustration.image_canvas.create_window(100, 950, anchor='sw', window=self.sign_up_nav)
        login_box = code_inc_widgets.LoginBox(self.screen, screen_switcher, "login_pass", user)
